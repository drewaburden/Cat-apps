...
public class ThirstMeter extends Meter {
	...
	public void startTracking(Activity _activity, int _progressBar,
		...
		this.value = (double) preferences.getFloat("thirst_value",
				(float) defaultValue);
		Long currTime = System.currentTimeMillis();
		Long timeChange = (currTime - preferences.getLong("thirst_time",
				currTime)) / 1000; // in Seconds
	...
	public void stopTracking() {
		...
		prefEditor.putFloat("thirst_value", (float) this.value);
		prefEditor.putLong("thirst_time", System.currentTimeMillis());
		prefEditor.apply();
	}
}
